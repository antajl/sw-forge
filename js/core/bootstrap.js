...
window.SWRM.STAT_TYPE_IDS = STAT_TYPE_IDS;
window.SWRM.statTypeIdFromCanonical = statTypeIdFromCanonical;
window.SWRM.displayStatForUi = displayStatForUi;
...
window.SWRM.DEFAULT_ARTIFACT_RULES = DEFAULT_ARTIFACT_RULES;
window.SWRM.DEFAULT_ARTIFACT_ROLES = DEFAULT_ARTIFACT_ROLES;
window.SWRM.ARTIFACT_PRI_MAIN = ARTIFACT_PRI_MAIN;
window.SWRM.mergeArtifactRules = mergeArtifactRules;
window.SWRM.mergeArtifactRoles = mergeArtifactRoles;
window.SWRM.saveArtifactRulesStorage = saveArtifactRulesStorage;
window.SWRM.loadArtifactRulesBundle = loadArtifactRulesBundle;
