...
const TRANSLATIONS = {
  en: {
    ...
    shareReviewMonsters: '{n} monsters · {partial} partial sets · {skill} skill levels to max',
    ...
    skillPlannerLead:
      'Plan devilmon and skill-ups across your box. Skill text and Cooldown hunt use the bundled skills database on this site (refresh with node tools/fetch-skills-index.mjs --fresh).',
  ...
  ru: {
    ...
    shareReviewMonsters: '{n} монстров · {partial} неполных сетов · {skill} уровней скиллов до макс.',
    ...
    skillPlannerLead:
      'План девилмонов и skill-up по всей коробке. Описания скиллов и «Охота на CD» — из локальной базы на сайте (обновление: node tools/fetch-skills-index.mjs --fresh).',
