...
const TRANSLATIONS = {
  en: {
    ...
    shareProfileDesc: 'Create a read-only link to your equipped monsters (or full inventory).',
    shareFullInventory: 'Include full inventory',
  ...
  ru: {
    ...
    shareFullInventory: 'Весь инвентарь',
...
const TRANSLATIONS_FR_PARTIAL = {
  ...
  shareFullInventory: 'Inventaire complet',
