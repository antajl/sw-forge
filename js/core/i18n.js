...
const TRANSLATIONS = {
  en: {
    ...
    tableScoreHint:
      'Forge Score: stat value tiers (main vs sub vs innate) + roll size + synergy bonuses and penalties. Not Eff% or verdict.',
    forgeScoreTooltip:
  ...
  ru: {
    ...
    tableScoreHint:
      'Forge Score: ценность статов (main / sub / innate) + размер ролла + синергии и анти-синергии. Не Eff% и не вердикт.',
    forgeScoreTooltip:
      'Main {mainPts} · Subs {subPts} · Innate {innatePts}. Синергия main↔sub ×{ms} · sub↔sub ×{ss} · дубли ×{dup}. Не Eff% и не вердикт.',
...
const TRANSLATIONS_FR_PARTIAL = {
  ...
  tableScoreHeader: 'Score',
  tableScoreHint:
    'Forge Score : valeur des stats + roll + synergies. Pas Eff% ni verdict.',
  forgeScoreTooltip:
    'Main {mainPts} · Subs {subPts} · Innate {innatePts}. Synergies ×{ms} ×{ss} · dup ×{dup}.',
  monstersDetailStats: 'Stats (SWEX)',
