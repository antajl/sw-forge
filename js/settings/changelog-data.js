// js/settings/changelog-data.js — part of settings load chain
/**
  ...
  },
  {
    ...
    items: {
      en: [
        ...
        'Developer workflow: UI script split into ordered parts under js/ui-parts/ with a rebuild step into js/ui.js; settings and CSS already modular.',
      ],
      ru: [
        ...
        'Для разработки: UI разбит на части в js/ui-parts/ со сборкой в js/ui.js; settings и CSS уже модульные.',
      ],
      fr: [
        ...
        'Workflow dev : UI découpé en js/ui-parts/ avec rebuild vers js/ui.js ; settings et CSS déjà modulaires.',
      ],
    },
  },
  {
