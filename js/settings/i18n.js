...
const TRANSLATIONS = {
  en: {
    ...
    monstersEmptyFiltered: 'No monsters match the filters.',
    ...
    monstersBulkFood: 'Mark food',
    monstersBulkStorage: 'Storage tag',
  ...
  ru: {
    ...
    monstersEmptyFiltered: 'Нет монстров по фильтрам.',
    ...
    monstersBulkFood: 'В food',
    monstersBulkStorage: 'Метка склада',
...
const TRANSLATIONS_FR_PARTIAL = {
  ...
  monstersEmptyFiltered: 'Aucun monstre ne correspond aux filtres.',
  ...
  monstersBulkFood: 'Marquer food',
  monstersBulkStorage: 'Tag stockage',
